          ...
          <View style={styles.subcontainer}>
            <View style={styles.headerContainer}>
              ...
              <View style={styles.albumContainer}>
                <Album
                  title={DATA2.item[0].title}
                  data={DATA2.item[0].albums}
                  onPress={() => this.props.navigation.navigate('Playlist')}
                />
                <Album
                  title={DATA2.item[1].title}
                  data={DATA2.item[1].albums}
                  onPress={() => this.props.navigation.navigate('Playlist')}
                />
                <Album
                  title={DATA2.item[2].title}
                  data={DATA2.item[2].albums}
                  onPress={() => this.props.navigation.navigate('Playlist')}
                />
                <Album
                  title={DATA2.item[3].title}
                  data={DATA2.item[3].albums}
                  onPress={() => this.props.navigation.navigate('Playlist')}
                />
              </View>
            </View>
...
const mapStateToProps = state => {
  // console.log(list, 'state at homescreen');
  return {
    list: state.dataFetcher,
  };
};
// const mapDispatchToProps = dispatch => ({
//   action: () => dispatch(fetchData()),
// });
