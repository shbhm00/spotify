    ...
    return (
      <Tab.Navigator
        tabBarOptions={{
          ...
          labelStyle: {marginBottom: Platform.OS === 'ios' ? null : vh(5)},
          style: {
            backgroundColor: '#333333',
            height: Platform.OS === 'ios' ? vh(80) : vh(65),
          },
        }}>
        <Tab.Screen
          name="Home"
          component={this.Home1}
          options={{
            tabBarIcon: ({focused}) =>
              focused ? (
                <Image
          ...
          options={{
            tabBarIcon: ({focused}) =>
              focused ? (
                ...
                <Image
                  style={styles.tabIcon}
                  source={require('../assets/search_inactive.png')}
                />
              ),
          }}
        />
          ...
          options={{
            tabBarIcon: ({focused}) =>
              focused ? (
                <Image
                  style={styles.tabIcon}
                  source={require('../assets/music_active.png')}
                />
              ) : (
                <Image
                  style={styles.tabIcon}
                  source={require('../assets/music_inactive.png')}
                />
              ),
          }}
        />
